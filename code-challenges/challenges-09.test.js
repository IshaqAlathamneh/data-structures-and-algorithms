...
const addValues = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((acc, value) => {return acc + value;}, 0);
  return newArr;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  let newArr = arr.reduce((acc, value) => {return acc + value.purchasePrice;}, 0);
  return newArr;
};
...
const reversedString = (str) => {
  ...
  return newStr.reduce((acc, value) => {return value + acc;}, '');
};
